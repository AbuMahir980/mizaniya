...
- **Endpoint**: method + path (e.g. `GET /api/v1/tasks`) or operationId if from OpenAPI.
...
- **Details**: concrete diff (e.g. "contract has `dueDate`; client sends `due_date`") or "verified OK".
