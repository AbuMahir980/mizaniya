  ...
  return (
    <section className="flex flex-col gap-2">
      ...
      <p className="font-structural text-body text-soft">
        This screen arrives in {ticket}. The shell, the navigation and the data beneath it
        are already here.
      </p>
    </section>
  )
...
export function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/welcome" element={<NotBuiltYet name="Welcome" ticket="T12" />} />

      <Route element={<ShellWithAnnouncer />}>
        <Route index element={<NotBuiltYet name="Home" ticket="T13" />} />
        <Route path="/plan" element={<NotBuiltYet name="Plan" ticket="T15" />} />
        <Route path="/transactions" element={<NotBuiltYet name="Transactions" ticket="T16" />} />
        <Route path="/debts" element={<NotBuiltYet name="Debts & Goals" ticket="T17" />} />
        <Route
          path="/debts/:id/record"
          element={<NotBuiltYet name="Debt record" ticket="T18" />}
        />
        <Route path="/months" element={<NotBuiltYet name="Months" ticket="T19" />} />
        <Route path="/settings" element={<NotBuiltYet name="Settings" ticket="T20" />} />
        <Route path="/zakat" element={<NotBuiltYet name="Zakat" ticket="T22" />} />
        <Route path="/more" element={<NotBuiltYet name="More" ticket="T13" />} />
        ...
        <Route path="*" element={<NotBuiltYet name="Not found" ticket="T13" />} />
      </Route>
    </Routes>
  )
}
